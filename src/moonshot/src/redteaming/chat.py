...
class Chat:
    ...
    def send_prompt(self, prompt: str) -> str:
        ...
        print("Final prepared prompt before sending out:", prepared_prompt)
    ...
    # def process_context_prompts(self, current_prompt: str, context_strategy: str) -> str:
    #     """
    #     Prepares the context for a prompt.
    ...
    #     # add context to prompt if required
    #     contextualised_prompt = current_prompt
    #     context_strategy_instance = self._get_context_strategy_instance(context_strategy)
    #     if context_strategy_instance:
    #        context_strategy_instance = context_strategy_instance()
    #        contextualised_prompt = context_strategy_instance.add_in_context(current_prompt)
    #        num_previous_prompts = context_strategy_instance.get_number_of_prev_prompts()

    #     # add previous prompts to current prompt if required
    #     previous_prompts = self.get_previous_prompts(num_previous_prompts)
    #     combination_of_previous_prompts = ""

    #     if previous_prompts:
    #         combination_of_previous_prompts += "Previous prompt:"
    ...
    #     # return final prompt
    #     return combination_of_previous_prompts + contextualised_prompt
